  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch(
        `http://localhost:4000/ml/users/1/update-attributes`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
            Authorization:
              "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImRtdG9zYXJ2ZXNoQGdtYWlsLmNvbSIsImlkIjoxLCJicm93c2VyIjoiUG9zdG1hblJ1bnRpbWUvNy40My4wIiwidmVyc2lvbiI6MywiaWF0IjoxNzQyNzI5MzQ3LCJleHAiOjE3NDI5ODg1NDd9.N6KpKRcFj2Z11gjliuqNlKeW5MifUe1Ln9sFzk4n2v8",
          },
              ...
              >
                {isEditing ? (
                  ...
                  <>
                    ...
                    <p className="text-foreground">Edit</p>
                  </>
                )}
              </Button>
            </div>
            ...
            <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        handleSelectChange(value, "additional_info.work_class")
                      }
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="cinematograph">
                          Cinematograph Film
                        </SelectItem>
                        <SelectItem value="sound_recording">
                          Sound Recording
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        handleSelectChange(
                          value,
                          "additional_info.publication_status"
                        )
                      }
                    >
              ...
              <div>
                ...
                <div className="grid grid-cols-1 gap-6">
                  <div>
                    <Label htmlFor="fee_payment_details">
                      Fee Payment Details
                    </Label>
                    <Textarea
